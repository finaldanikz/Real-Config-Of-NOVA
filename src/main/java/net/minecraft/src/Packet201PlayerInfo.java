...
public class Packet201PlayerInfo extends Packet {
	...
	public Packet201PlayerInfo(String par1Str, boolean par2, int par3) {
		...
		this.ping = par3;
		if(Client.INSTANCE.modManager.pingspoofer.isEnabled() && Client.INSTANCE.modManager.pingspoofer.getPing() != -1) this.ping = (int) Client.INSTANCE.modManager.pingspoofer.getPing();
	}
