...
public class PlayerControllerMP {
	...
	public float getBlockReachDistance() {
		return Client.INSTANCE.modManager.reach.isEnabled() ? Client.INSTANCE.modManager.reach.reach.getValue() : this.currentGameType.isCreative() ? 5.0F : 4.5F;
	}
	...
	public boolean sendUseItem(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack) {
		Client.INSTANCE.modManager.onEvent(new EventUseItem());
		this.syncCurrentPlayItem();
	...
	public void attackEntity(EntityPlayer par1EntityPlayer, Entity par2Entity) {
		this.syncCurrentPlayItem();
		Client.INSTANCE.modManager.onEvent(new EventAttack(par2Entity));
