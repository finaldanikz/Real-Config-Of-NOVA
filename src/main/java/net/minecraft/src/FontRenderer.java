...
public class FontRenderer {
	...
	public int drawString(String par1Str, int par2, int par3) {
		return this.drawString(par1Str, par2, par3, false);
	}
	...
	public int drawString(String par1Str, int par2, int par3, boolean par5) {
		this.resetStyles();

		int var6;

		if (par5) {
			var6 = this.renderString(par1Str, par2 + 1, par3 + 1, true);
			var6 = Math.max(var6, this.renderString(par1Str, par2, par3, false));
		} else {
			var6 = this.renderString(par1Str, par2, par3, false);
		}
	...
	private int renderString(String par1Str, int par2, int par3, boolean par5) {
		if (par1Str == null) {
			return 0;
		} else {
			this.posX = (float) par2;
