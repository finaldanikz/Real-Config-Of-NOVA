...
public class Gui {
	 ...
	 * x1, y1, x2, y2, color
	 */
	public static void drawRect(double d, double e, double f, double g, int par4) {
		double var5;
		...
		var9.addVertex((double) d, (double) g, 0.0D);
		var9.addVertex((double) f, (double) g, 0.0D);
		var9.addVertex((double) f, (double) e, 0.0D);
	...
	public static void drawRect(int par0, int par1, int par2, int par3) {
		int var5;
