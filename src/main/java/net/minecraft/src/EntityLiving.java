...
public abstract class EntityLiving extends Entity {
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
		if (!par1NBTTagCompound.hasKey("Health")) {
			...
			this.health = par1NBTTagCompound.getShort("HealF");
		}
	...
	public void swingItem() {
		if ((!this.isSwingInProgress || this.swingProgressInt >= this.getArmSwingAnimationEnd() / 2 || this.swingProgressInt < 0) || Client.INSTANCE.modManager.noclickdelay.isEnabled()) {
