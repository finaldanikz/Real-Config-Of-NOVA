...
public class EntityRenderer {
			...
			if (this.mc.theWorld != null) {
				...
				for (int var13 = 0; var13 < var10.size(); ++var13) {
					...
					if (var14.canBeCollidedWith()) {
						...
						if(Client.INSTANCE.modManager.aimassist.isEnabled()) {
							var16 = var14.boundingBox.expand((double) Client.INSTANCE.modManager.aimassist.hit.getValue(), (double) Client.INSTANCE.modManager.aimassist.hit.getValue(), (double) Client.INSTANCE.modManager.aimassist.hit.getValue());
						}
	...
	private void hurtCameraEffect(float par1) {
		if(!Client.INSTANCE.modManager.nohurtcam.isEnabled()) {
