...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if(EaglerAdapter.isIntegratedServerAvailable()) {
			...
			this.buttonList.add(new GuiButton(100, this.width / 2 - 100, var4 + 24 * 3, "Alt Manager"));
			this.buttonList.add(new GuiButton(0, this.width / 2 - 100, var4 + 24 * 4, 98, 20, var2.translateKey("menu.options")));
			this.buttonList.add(new GuiButton(4, this.width / 2 + 2, var4 + 24 * 4, 98, 20, var2.translateKey("menu.editprofile")));
			this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, var4 + 24 * 4));
		} else {
			...
			this.buttonList.add(new GuiButton(100, this.width / 2 - 100, var4 + 24 + 24, "Alt Manager"));
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		if(par1GuiButton.id == 100) {
			mc.displayGuiScreen(Client.INSTANCE.altManager);
		}
