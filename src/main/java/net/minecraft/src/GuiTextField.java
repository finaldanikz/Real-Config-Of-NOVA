...
public class GuiTextField extends Gui {
	...
	public GuiTextField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5, boolean password) {
		this.fontRenderer = par1FontRenderer;
		this.xPos = par2;
		this.yPos = par3;
		this.width = par4;
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			if (var4.length() > 0) {
				...
				var9 = this.fontRenderer.drawStringWithShadow(password ? var10.replaceAll(".", "\u25CF") : var10, var7, var8, var1);
			}
